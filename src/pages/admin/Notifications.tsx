...
const Analytics = () => {
  ...
  const peakHours = [
    { hour: "12:00", orders: 89, load: "cao" },
    { hour: "13:00", orders: 95, load: "cao" },
    { hour: "19:00", orders: 67, load: "trung bình" },
    { hour: "20:00", orders: 72, load: "trung bình" }
  ];
  ...
  const anomalies = [
    { 
      id: 1, 
      type: "spike", 
      description: "Tăng bất thường số lượng đơn tại Quận 1", 
      time: "2 giờ trước",
      severity: "trung bình"
    },
    { 
      id: 2, 
      type: "drop", 
      description: "Giảm số lượng đơn của các quán cà phê", 
      time: "4 giờ trước",
      severity: "thấp"
    },
    { 
      id: 3, 
      type: "error", 
      description: "Phát hiện tỷ lệ hủy cao", 
      time: "6 giờ trước",
      severity: "cao"
    }
  ];
        ...
        <div className="grid lg:grid-cols-2 gap-6">
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle>Nhà cung cấp hoạt động tốt nhất</CardTitle>
